...
export default function SortingSelecting(props) {
  ...
  const companyScore = props.data['esg-score'].score;
  const industry = props.data['sector-data'][0].sector;
  const industryScore = props.data['sector-data'][0]['avg-esgscore'];
  const { country } = props.data['country-data'][0];
  const countryScore = props.data['country-data'][0]['avg-esgscore'];
